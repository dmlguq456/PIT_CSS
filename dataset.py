...
class SpectrogramReader(object):
    ...
    def __init__(self, wave_scp, rir_list, noise_dir, train, num_mics, max_frame, loss, **kwargs):
    ...
    def rir_filter_choice(self):
        ...
        num_deg = self.rir_filter[room][idx2][RT].shape[2]
        ...
        return degs_diff, degs, h_target, np.transpose(noise)
        
    def RIR_mixing(self, key):
        degs_diff, degs, h, noise = self.rir_filter_choice()
        ...
        return samps_fin, samps_src_rir_d_2, samps_src_rir_d, noise_SNR, degs_diff, degs
...
class Datasets(object):
    ...
    def __getitem__(self, index):
        ...
        mix, ref_rir, ref, noise, degs_diff, degs = self.mix_reader[key]
        
        return {"num_sample" : mix.shape[0], "mix":mix, "ref_rir":ref_rir, "ref":ref, "noise":noise, "degs_diff":degs_diff, "degs":degs}
