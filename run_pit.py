...
# from trainer_copy2 import PITrainer
# from trainer_MVDR import PITrainer
...
def train(args):
    ...
    if config_dict["model_type"] == "Conformer":
        nnet = ConformerCSS(**dcnnet_conf)

    if args.test_mode:
        tester = PITester(nnet, reader_conf, **config_dict["trainer"], gpuid=gpuid)
