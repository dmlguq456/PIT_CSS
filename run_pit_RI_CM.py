...
from trainer_RI_CM import PITrainer_RI
...
from model.DPMCN_v16_CM import DPMCN_v16_CM
...
def train(args):
    ...
    elif config_dict["model_type"] == "DPMCN_v16_CM":
        nnet = DPMCN_v16_CM(**dcnnet_conf)
