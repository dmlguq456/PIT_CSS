...
# for dataset, nsample in {'cv':10,'tt':10}.items():
                ...
                for room, num_src in {'medium':18, 'small':14}.items():
                    for RT in [0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6]:
                        ...
                        # for beta in [0, 0.25, 0.5, 0.75, 1, 1.25, 1.5, 1.75, 2]:
                            ...
                            path = DIR+'/noise_beta_'+str(beta)+'_room_'+room+'/mic_deg_'+str(mic_deg_tmp)+'_center_'+str(mic_center[0])+'_'+str(mic_center[1])+'_mic_r_'+str(mic_radius)+'_RT_'+str(RT)
